...
*/
	...
	//Testimonial Carousel duble column
	$('.testimonial-duble .owl-carousel').owlCarousel({
	   autoplay: true,
	   margin: 30,
	   loop: true,
	   nav: false,
...
*/	
	...
	function submitquoteForm(){
		...
		$.ajax({
			...
			data: "fname=" + fname + "&email=" + email + "&phone=" + phone + "&service=" + service,
...
*/
	function myMap() {
		...
		var infowindow = new google.maps.InfoWindow({
			content:'<div class="map-marker"><h3>YOUR COMPANY</h3><p>70 Trent Rd, Luton LU3 1TA, UK.</p></div>'
		});
...
*/
	$(function() { 
		...
		$('.toggle-price-professional-year').hide(); 
		$('.toggle-price-maximum-year').hide(); 
	...
	function changePlanProfessional(plan) { 
		$('[class^="toggle-price-professional"]').hide(); 
		$('.toggle-price-professional-' + plan).show(); 
	} 	
	function changePlanMaximum(plan) { 
		$('[class^="toggle-price-maximum"]').hide(); 
		$('.toggle-price-maximum-' + plan).show(); 
	}
